...
public class KingdomBuilderPanel extends JPanel implements MouseMotionListener, MouseListener {
    ...
    public void mouseMoved(MouseEvent e) {
        int x=e.getX(), y=e.getY();
        if(x >= 1263- ObjectiveCard.WIDTH && y>= 30 && x<= 1263 - ObjectiveCard.WIDTH/2 && y <= 30 + ObjectiveCard.HEIGHT){
            System.out.println("UWU");
        } else if(x >= 1263 && y>=30 && x<= 1263 + ObjectiveCard.WIDTH/2 && y <= 30 + ObjectiveCard.HEIGHT){
            System.out.println("Hello World");
        } else if(x >= 1263 + ObjectiveCard.WIDTH/2 && y>=30 && x<= 1263 + ObjectiveCard.WIDTH && y <= 30 + ObjectiveCard.HEIGHT){
